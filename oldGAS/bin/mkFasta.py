...
def printHelp():
  ...
  print("example:\n\t./mkTree.py /scratch/EPITOOLS/GAS/nasp/All\n")
  exit(0)
...
def main():
  ...
  print("fasta")
  subprocess.call("module purge; module load nasp; nasp export --type fasta " + best + " > " + bestFasta, universal_newlines=True, shell=True)
  subprocess.call("module purge; module load nasp; nasp export --type fasta " + missing + " > " + missingFasta, universal_newlines=True, shell=True)
