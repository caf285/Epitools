...
def printHelp():
  ...
  print("\tNASP\tdirectory of nasp run in /scratch/EPITOOLS/GAS/.temp/")
...
def main():
  ...
  if "-h" in sys.argv:
    ...
    tempDir = "/scratch/EPITOOLS/GAS/.temp/" + sys.argv[1] + "/"
    naspDir = "/scratch/EPITOOLS/GAS/nasp/ALL\:\:" + sys.argv[2] + "/"
